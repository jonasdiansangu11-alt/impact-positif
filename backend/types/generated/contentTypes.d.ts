...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    ourRoleContent: Schema.Attribute.Text;
    ourRoleTitle: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whoAreWeContent: Schema.Attribute.Text;
    whoAreWeTitle: Schema.Attribute.String;
  };
}
...
export interface ApiAdAd extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    position: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'home-middle'>;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.String & Schema.Attribute.DefaultTo<'banner'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    contactImage: Schema.Attribute.Media<'images'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'IMPACT POSITIF'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    titleHighlight1: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'IMPACT'>;
    titleHighlight2: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'POSITIF'>;
    titlePrefix: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Nous sommes'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMediathequeMediatheque extends Struct.CollectionTypeSchema {
  collectionName: 'mediatheques';
  info: {
    displayName: 'Mediatheque';
    pluralName: 'mediatheques';
    singularName: 'mediatheque';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiRealizationRealization extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::mediatheque.mediatheque': ApiMediathequeMediatheque;
