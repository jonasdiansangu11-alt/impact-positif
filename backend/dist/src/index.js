    ...
    async bootstrap({ strapi }) {
        ...
        try {
            ...
            if (mediathequeCount === 0) {
                const medias = [
                    { title: "Séminaire de rentrée", category: "Événements", mediaType: "photo" },
                    { title: "Backstage Soirée VIP", category: "Backstage", mediaType: "photo" },
                    { title: "Campagne RDC 2025", category: "Campagnes", mediaType: "video" },
                    { title: "Atelier Stratégie Digitale", category: "Ateliers", mediaType: "photo" }
                ];
